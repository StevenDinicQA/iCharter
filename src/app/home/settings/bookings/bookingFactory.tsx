...
export const bookingFactory = (payload: any): Booking[] => {
  return payload.map((bookingPayload: Booking) => {
    return {
      ...
      metadata: {
        ...
        discountAmount: bookingPayload?.metadata?.discountAmount,
      ...
      listing: {
        ...
        charterProfile: {
          ...
          companyName: bookingPayload?.listing?.charterProfile?.companyName,
        },
      },
    };
  });
