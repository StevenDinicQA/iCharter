...
function ConfirmEmail() {
  ...
  async function handleConfirmEmail() {
    ...
    const { error } = await apiService.post("auth/confirmRegistration", body);
    ...
    mixPannelService.trackEvent("Completed Sign Up", {
      email,
      userType: Cookies.get("userType") || "customer",
    });
  ...
  useEffect(() => {
    if (URLverficationCode) {
      setCodeValues(URLverficationCode);
      return;
    }
